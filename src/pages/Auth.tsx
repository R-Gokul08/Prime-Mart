...
import { Mail, Lock, User, ArrowRight, Loader2, ShoppingCart } from 'lucide-react';
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription>Sign in to sync your grocery lists across devices</CardDescription>
          </CardHeader>
